						...
						<div class='col-lg-6 col-md-6 col-sm-12 text-center'>
							<div class='inner-column'>
								...
								<p>
									...
									adipiscing elit. Pellentesque auctor
									suscipit feugiat. Ut at pellentesque ante,
									sed convallis arcu. Nullam facilisis, eros
									in eleifend luctus, odio ante sodales augue,
									eget lacinia lectus erat et sem.{' '}
								</p>
								<p>
									Sed semper orci sit amet porta placerat.
									Etiam quis finibus eros. Sed aliquam metus
									lorem, a pellentesque tellus pretium a.
									Nulla placerat elit in justo vestibulum, et
								...
								<div class='carousel-inner mt-4'>
									<div class='carousel-item text-center active'>
										...
										<p class='m-0 pt-3'>
											...
											consectetur adipiscing elit. Nam eu
											sem tempor, varius quam at, luctus
											dui. Mauris magna metus, dapibus nec
											turpis vel, semper malesuada ante.
											Idac bibendum scelerisque non non
											purus. Suspendisse varius nibh non
											aliquet.
										</p>
									</div>
				...
				<div class='container'>
					<div class='row'>
						<div class='col-lg-3 col-md-6'>
							<h3>About Us</h3>
							<p>
								Integer cursus scelerisque ipsum id efficitur.
								Donec a dui fringilla, gravida lorem ac, semper
								magna. Aenean rhoncus ac lectus a interdum.
								Vivamus semper posuere dui, at ornare turpis
								ultrices sit amet. Nulla cursus lorem ut nisi
								porta, ac eleifend arcu ultrices.
							</p>
						</div>
						<div class='col-lg-3 col-md-6'>
							<h3>Opening hours</h3>
						...
						<div class='row'>
							<div class='col-lg-12'>
								<p class='company-name'>
									...
									<a href='#'>Yamifood Restaurant</a> Design
									By :
